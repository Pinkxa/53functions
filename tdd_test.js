...
TestMyCode.run("testing hello_uppercase function", function(assert) {
    var result = hello_uppercase("Pretty");
    // is the result as we expected?
    assert.equals("Hello, Pretty", result, "testing hello_uppercase function");
});
...
TestMyCode.run("testing sum_numbers function", function(assert) {
	...
	//is the result as we expected?
	assert.equals(66, result, "testing sum_numbers function");
});
